# SimpleModBusCommExample

This project is a simple example of an alternative Modbus communication on Beckhoff's TwinCAT3 platform.
...
To run this project you will need to register and get Inxton developer license [here](https://inxton.com/register).
